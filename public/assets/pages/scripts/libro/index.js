            ...
            success: function (respuesta) {
                if (funcion == 'eliminarLibro') {
                    if (respuesta.mensaje == "ok") {
                        ...
                        School_system.notificaciones('El registro fue eliminado correctamente', 'School_system', 'success');
                    } else {
                        School_system.notificaciones('El registro no pudo ser eliminado, hay recursos usandolo', 'School_system', 'error');
                    }
