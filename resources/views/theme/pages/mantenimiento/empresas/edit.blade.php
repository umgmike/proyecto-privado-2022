...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{route('page.update.empresas', [$registro->id])}}" id="GuardarEmpresas" method="POST" autocomplete="off">
                @csrf
                @method("put")
                <div class="row">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="empresa">Editar empresa de vuelo : </label>
                                        <input type="text" id="empresa" name="empresa" class="form-control" value="{{old('empresa', $registro->empresa ?? '')}}"/>
                                    </div>
