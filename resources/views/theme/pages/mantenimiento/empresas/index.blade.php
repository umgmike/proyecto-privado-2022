        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-header">
                <a href=" {{ route('page.create.empresas') }} " class="btn btn-info tooltipsC" title="Crear registro del @yield('Title')">
                ...
                <tbody>
                  @foreach ($empresas as $rs)
                    <tr>
                        ...
                        <td>{{ $rs->updated_at }}</td>
                        <td>
                            <a href="{{ route('page.edit.empresas', ['id' => $rs->id])}}"´class="tooltipsC" title="Editar registro">
