...
@section("scripts")
  <script src="{{asset("assets/pages/scripts/pasajeros/pasajeros.js")}}" type="text/javascript"></script>
@endsection
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <h4>
            <i class="fa fa-user-graduate"><strong> @yield('Title') </strong> </i>
          </h4>
        </div>
      </div>
    </div>
                  ...
                  <div class="card-body row">
                    ...
                    <div class="col-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control" data-inputmask='"mask": "9999-9999"' data-mask/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="dpi" name="dpi" class="form-control" data-inputmask='"mask": "9999 99999 9999"' data-mask/>
                      </div>
